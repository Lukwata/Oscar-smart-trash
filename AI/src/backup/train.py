...
tf.flags.DEFINE_string(
    ...
    "final_layer,aux_11,output_layer",
...
tf.flags.DEFINE_string(
    "obj_to_class_file",
    "data/interim/trashnet_new/obj_to_class.json",
    "Path to the JSON file contains the mapping from object to class."
)

tf.flags.DEFINE_string(
    "train_metadata",
    "data/interim/trashnet_new/trashnet-train_metadata.json",
    "JSON file stores the metadata of the training set."
)
tf.flags.DEFINE_string(
    "train_file_pattern",
    "data/interim/trashnet_new/trashnet-train-*",
...
tf.flags.DEFINE_string(
    "eval_file_pattern",
    "data/interim/trashnet_new/trashnet-val-*",
