...
def random_rotate(image, max_angle):
  """Randomly rotate an image between [-max_angle, max_angle] (in degrees)."""
...
def random_zoom(image):
  """Randomly zoom in/out of an image (with the image center as pivot)."""
  z = tf.exp(tf.random_uniform([], minval=math.log(1/1.3),
                               maxval=math.log(1.3)))
...
def preprocess_for_train(image,
  ...
  image = tf.image.random_saturation(image, 1. / 2, 2.)
