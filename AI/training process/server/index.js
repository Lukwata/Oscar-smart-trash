...
app.post("/api/Upload", function(req, res) {
    ...
    let record_r = "sudo arecord -D hw:1,0 -d 3 -f cd "+__dirname +'/images/'+classtrash+"/"+tmpName +"_r1.wav -c 1";
    //let record_l = "sudo arecord -D hw:1,0 -d 3 -f cd "+__dirname +'/images/'+classtrash+"/"+tmpName +"_r2.wav -c 1";
    exec_cmd(camleft, (error, stdout, stderr) =>{ console.log(stdout)})
    exec_cmd(camright, (error, stdout, stderr) =>{ console.log(stdout)})
    exec_cmd(record_r, (error, stdout, stderr) =>{ console.log(stdout)})
    //exec_cmd(record_l, (error, stdout, stderr) =>{ console.log(stdout)})
