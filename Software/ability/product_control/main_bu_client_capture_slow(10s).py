...
def capturecc(cam):
    ...
    os.system("sudo fswebcam -d /dev/video"+cam+" -r 640x320 /home/pi/aos/data/saveIMG/"+timestr+".jpg")
    #print( time.time()-t)
    #print ("done")
    if cam == "0":
        DONE_CAM0=True
            ...
            if self.event.wait(1):
                try:
                    ...
                    if (detect_count==0 or detect_count >=MAX_TIME_DELAY) and message!=None and message["ID"]=="COVER_STATUS" and message["Value"]==1: 
                        ...
                        timestr = time.strftime("%d%m%Y-%H%M%S") + "_C0"
                        timestr = "/home/pi/aos/data/saveIMG/"+timestr + ".jpg"
