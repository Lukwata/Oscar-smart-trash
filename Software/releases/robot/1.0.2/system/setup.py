                ...
                if self.connect_wifi():
                    ...
                    if wifi_data['product_id'] != '':
                        ...
                        if firebase.get_firebase_uid(wifi_data['product_id'] + __EMAIL_FIX__, wifi_data['user_hash']):
                            ...
                            device = Device(wifi_data['verify_code'], wifi_data['product_id'], wifi_data['product_name'], wifi_data['product_type'], wifi_data['address_long'], wifi_data['address_lat'], wifi_data["time_zone"], wifi_data['source'])
