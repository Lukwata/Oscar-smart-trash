...
REQUIREMENT_FIRMWARE_PATH = FIRMWARE_UPDATE__TMP_PATH + "system/"+DEVICE_TYPE+"/requirements.txt"
...
PATH_PRODUCT_KEY_CONFIG = CURRENT_PATH + 'data/product_key.json'
PATH_PRODUCT_ADDRESS = CURRENT_PATH + 'data/product_address.json'
